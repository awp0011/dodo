 ...
 * 
 */
public class ConfigurationFactoryBean extends	CommonsConfigurationFactoryBean {
	...
	protected String parseStringValue(String strVal, Properties props,
			@SuppressWarnings("rawtypes") Set visitedPlaceholders) throws BeanDefinitionStoreException {
